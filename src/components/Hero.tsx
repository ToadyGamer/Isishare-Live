  ...
  return (
    <div id="hero" className="relative isolate px-6 pt-14 lg:px-8">
      <div
        ...
        aria-hidden="true"
      >
        <div className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#609cf3] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]" />
      </div>
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div className="text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Bienvenue sur Isishare, la plateforme innovante conçue
            spécifiquement pour les écoles, où les étudiants peuvent développer
            des relations, partager leurs connaissances et s&apos;entraider dans
